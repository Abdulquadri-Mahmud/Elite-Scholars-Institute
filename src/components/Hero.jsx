...
export default function Hero() {
  return (
    <div className="lg:p-5 p-2">
      <div className="h-[80vh] flex flex-col items-center justify-center text-white rounded-lg bg-linear-to-r from-blue-600 to-green-700 shadow-lg">
        <h1 className="text-center lgtext-5xl text-4xl font-bold mb-4 drop-shadow-lg">Welcome to Elite Scholars Institute</h1>
